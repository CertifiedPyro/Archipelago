...
TEST_CASES = [
    TestCase(  # Room on top-left w/ 2 cogs
        room_name="SlimeCorp Excavation Site (X-2, Y-1) - lor524 (Main)",
    ...
    TestCase(  # Room before one-way path to dungeon
        room_name="SlimeCorp Excavation Site (X+1, Y+4) - lor755",
        location_map_name=None,
        possible_items={Difficulty.option_normal: [[M.DASH], [M.RIDE], [M.UFO]]},
    ),
    TestCase(
        room_name="SlimeCorp Excavation Site (X+5, Y-1) - lor1228",
        location_map_name="Badge (Wing)",
        possible_items={Difficulty.option_normal: [[M.OFF]]},
    ),
    TestCase(
        room_name="SlimeCorp Excavation Site (X+2, Y+4) - lor770",
        location_map_name="Badge (Berserker)",
        possible_items={Difficulty.option_normal: [[M.DASH], [M.RIDE], [M.UFO]]},
    ),
    TestCase(
        room_name="SlimeCorp Excavation Site (X+4, Y+3) - lor256",
    ...
    TestCase(
        room_name="SlimeCorp Excavation Site (X+0, Y+8) - lor1089",
    ...
    TestCase(
        room_name="SlimeCorp Excavation Site (X-4, Y+7) - lor1309",
    ...
    TestCase(
        room_name="SlimeCorp Excavation Site (X-4, Y+6) - yug3 (West)",
        location_map_name="Petal Container 2",
        possible_items={Difficulty.option_normal: [[M.DASH], [M.RIDE]]},
    ),
    TestCase(
        room_name="SlimeCorp Excavation Site (X+3, Y+5) - lor856",
